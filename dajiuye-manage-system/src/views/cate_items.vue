  ...
  <div>
    <div class="container">
      ...
      <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
        <el-table-column prop="name" :show-overflow-tooltip="true" width="155" label="name" align="center">
        </el-table-column>
        <el-table-column prop="navigatorUrl" :show-overflow-tooltip="true" label="jobName" width="155"
          align="center"></el-table-column>
        <el-table-column prop="openType" :show-overflow-tooltip="true" label="jobPlace" width="155"
          align="center"></el-table-column>
    ...
    <el-dialog title="编辑" v-model="editVisible" width="30%">
      <el-form label-width="70px">
        ...
        <el-form-item label="openType" label-width="120px">
          <el-input v-model="form.openType"></el-input>
        </el-form-item>
...
import { catitems, updateCatitems } from '../api/index';

const isEdit = ref(false)

const tableData = ref<CatItem[]>([]);
